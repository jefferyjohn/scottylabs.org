  ...
  return (
    <BaseIcon className={className} debugBbox={debugBbox}>
      ...
      >
        ...
        <defs>
          <linearGradient id="c">
            <stop stopColor="#2d3335" offset={0} />
            <stop stopColor="#4c464a" offset={0.5} />
            <stop stopColor="#384042" offset={1} />
          </linearGradient>
          <linearGradient id="a">
            <stop offset={0} />
          ...
          <linearGradient
            ...
            x1={120}
          >
            <stop stopColor="#f9e295" offset={0} />
            <stop stopColor="#f7dd84" offset={0.125} />
            <stop stopColor="#fff" offset={0.206} />
            <stop stopColor="#f4ce51" offset={0.301} />
            <stop stopColor="#f9e7aa" offset={0.341} />
            <stop stopColor="#efbb0e" offset={1} />
          </linearGradient>
          <linearGradient
            id="P"
            y2={186.5}
          ...
          <radialGradient
            ...
            r={47}
          >
            <stop stopColor="#d0e9f2" stopOpacity={0} offset={0} />
            <stop stopColor="#d0e9f2" stopOpacity={0} offset={0.839} />
            <stop stopColor="#d0e9f2" stopOpacity={0.282} offset={0.943} />
            <stop stopColor="#d0e9f2" offset={1} />
          </radialGradient>
          <radialGradient
            id="Q"
            gradientUnits="userSpaceOnUse"
          ...
          >
            <stop stopColor="#fff" offset={0} />
            <stop stopColor="#fff" stopOpacity={0.93} offset={0.5} />
            <stop stopColor="#fff" stopOpacity={0} offset={1} />
          </radialGradient>
          <radialGradient
            id="X"
        ...
        />
        <g transform="translate(0 -10)" clipPath="url(#i)">
          <path
            fill="#a6dd8b"
        ...
        >
          ...
          <path
            ...
            fill="none"
          />
          <g stroke="#6d7f42" fill="none" clipPath="url(#E)">
            <path
              opacity={0.387}
              strokeLinejoin="round"
              d="M15.75 151.25c33-2.5 38.25-3.5 36.25-10.25s-8.75-23.5-23-22.5-22.75-6.75-22.75-6.75"
